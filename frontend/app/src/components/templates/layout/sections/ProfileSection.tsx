...
import { PencilSquareIcon, EnvelopeIcon, UserIcon } from '@heroicons/react/24/outline';
import { useRouter } from 'next/navigation';
...
export default function ProfileSection() {
  ...
  return (
    <div className="flex items-center space-x-4 gap-[50px]">
      {loggedIn ? (
        // After Login UI
        <>
          <EnvelopeIcon className="h-5 w-5 text-gray-500" />
          <UserIcon className="h-5 w-5 text-gray-500" />
          <button className="px-4 py-1 border border-blue-500 text-blue-500 rounded hover:bg-blue-100">
            下書き保存
          </button>
        ...
        <>
          ...
          <button onClick={()=>onClickCreateArticle()} className="w-[173px] h-[55px] top-[56px] left-[1173px] gap-0 rounded-[6px] bg-[#00A4E5] flex justify-center text-white text-[20px] flex items-center gap-2">
            <PencilSquareIcon className="h-[25px] w-[25px] text-white" />
            <span>記事投稿</span>
          </button>
        </>
      )}
