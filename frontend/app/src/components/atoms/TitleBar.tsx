...
const TitleBar = ({ children, className, onClick, href }: Props) => {
    if (href) {
        return (
            <Link
                href={href}
                className='w-full flex items-center gap-[8px] rounded-lg px-[16px] sm:px-[24px] py-[16px] mb-[24px] cursor-pointer hover:no-underline text-[#364152] hover:text-[#364152]'
            >
